...
(function (root) {
  ...
  var STATUS_HINT = {
    ...
    id: {
      ...
      interview:    'Wawancara Anda telah selesai. Mohon tunggu keputusan penerimaan.',
    ...
    en: {
      ...
      interview:    'Your interview is complete. Please wait for the admission decision.',
  ...
  var SCH_DICT = {
    zh: {
      ...
      'sch.verify_h':        '身份验证',
      'sch.verify_hint':     '请输入您的姓名及 WhatsApp 后 4 位（与课程申请时填写一致）。',
      'sch.no':              '姓名',
      'sch.no_ph':           '与申请表一致的姓名',
      'sch.secret':          'WhatsApp 后 4 位',
      'sch.secret_ph':       '手机号/WhatsApp 末 4 位数字',
      'sch.verify_btn':      '验证身份',
      'sch.verifying':       '验证中…',
      'sch.not_found':       '未找到匹配记录，请核对姓名与 WhatsApp 后 4 位是否一致。',
      'sch.not_admitted':    '您的申请尚未进入录取状态（当前：{status}），请等待录取结果后再填写奖学金申请。',
      'sch.already_submitted': '您已提交过奖学金申请，请到「查询状态」页面查看审核进度。',
      'sch.form_h':          '奖助学金申请表',
      'sch.form_hint':       '请结合自身实际情况如实填写。学院盼望与学员一同承担福音工人的训练与预备，也鼓励学员按着自己的感动与能力参与费用承担。学院将根据实际情况进行审核。',
      'sch.fee_h':           '费用明细（年度）',
      'sch.fee_detail':      '学费（Tuition）：$3,000\n餐费（Meals）：$1,200（$100 × 12 个月）\nMYC 住宿费（Accommodation）：$720（$60 × 12 个月）（家庭学员需自行解决住房）\n　　※ 住宿费不包含在奖助学金范围内，需自行缴纳。对于确有实际经济困难的学员，可向神学院提出申请，学院将根据具体情况进行评估，并酌情给予减免。\n\n奖助学金最高资助限额：$4,200（学费 + 餐费）\n\n* 注意：所申请奖助学金若获批准，将直接核减相应费用，不发放到个人。',
    ...
    id: {
      ...
      'sch.verify_hint':     'Masukkan nama lengkap dan 4 digit terakhir WhatsApp (sama seperti saat mendaftar).',
      'sch.no':              'Nama lengkap',
      'sch.no_ph':           'Sama dengan formulir pendaftaran',
      'sch.secret':          '4 digit terakhir WhatsApp',
      'sch.secret_ph':       '4 digit terakhir nomor/WA',
      'sch.verify_btn':      'Verifikasi',
      'sch.verifying':       'Memverifikasi…',
      'sch.not_found':       'Data tidak ditemukan. Periksa nama dan 4 digit terakhir WhatsApp.',
      ...
      'sch.form_hint':       'Mohon isi dengan jujur sesuai kondisi aktual Anda. Institusi berharap dapat bersama-sama menanggung biaya pelatihan dan persiapan pekerja Injil bersama mahasiswa, dan mendorong mahasiswa untuk berkontribusi sesuai kemampuan dan panggilan hati mereka. Panitia akan meninjau setiap permohonan secara individual.',
      'sch.fee_h':           'Rincian Biaya (Tahunan)',
      'sch.fee_detail':      'Biaya Kuliah (Tuition): $3.000\nBiaya Makan (Meals): $1.200 ($100 × 12 bulan)\nBiaya Asrama MYC (Accommodation): $720 ($60 × 12 bulan) (mahasiswa berkeluarga mengatur sendiri)\n　※ Biaya asrama tidak termasuk dalam cakupan beasiswa; harus dibayar sendiri. Bagi mahasiswa yang benar-benar mengalami kesulitan ekonomi, dapat mengajukan permohonan kepada seminari; seminari akan menilai situasi secara individual dan dapat memberikan keringanan sesuai kebijakan.\n\nBatas maksimum bantuan beasiswa: $4.200 (kuliah + makan)\n\n* Catatan: Beasiswa yang disetujui akan langsung dipotong dari tagihan; tidak dibayarkan tunai ke individu.',
    ...
    en: {
      ...
      'sch.verify_hint':     'Enter your full name and the last 4 digits of WhatsApp (same as on your application).',
      'sch.no':              'Full name',
      'sch.no_ph':           'Same as on your application form',
      'sch.secret':          'Last 4 digits of WhatsApp',
      'sch.secret_ph':       'Last 4 digits of phone/WA',
      'sch.verify_btn':      'Verify',
      'sch.verifying':       'Verifying…',
      'sch.not_found':       'No matching record. Please check your name and WhatsApp last 4 digits.',
      ...
      'sch.form_hint':       'Please fill in honestly based on your actual situation. The seminary hopes to share together with students in the training and preparation of gospel workers, and encourages each student to contribute according to their own sense of calling and capacity. The committee will review each application individually.',
      'sch.fee_h':           'Annual Expense Breakdown',
      'sch.fee_detail':      'Tuition: $3,000\nMeals: $1,200 ($100 × 12 months)\nMYC Accommodation: $720 ($60 × 12 months) (students with families arrange their own housing)\n　※ Accommodation is not covered by the scholarship and must be paid separately. Students with genuine financial hardship may apply to the seminary; the seminary will assess each case and may grant a reduction at its discretion.\n\nMaximum scholarship/aid amount: $4,200 (tuition + meals)\n\n* Note: Approved scholarships will be applied directly as fee reductions; funds are not disbursed to individuals.',
