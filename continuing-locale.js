...
(function (root) {
  ...
  var SCH_DICT = {
    zh: {
      ...
      'sch.verify_h':        '身份验证',
      'sch.verify_hint':     '请输入您的姓名及 WhatsApp 后 4 位（与进深课程申请时填写一致）。若记得申请编号，也可填编号 + 邮箱或后 4 位。',
      'sch.no':              '姓名',
      'sch.no_ph':           '与申请表一致的姓名',
    ...
    id: {
      ...
      'sch.verify_hint':     'Masukkan nama lengkap dan 4 digit terakhir WhatsApp (sama seperti saat mendaftar). Jika ingat nomor permohonan, bisa pakai nomor + email atau 4 digit.',
      'sch.no':              'Nama lengkap',
    ...
    en: {
      ...
      'sch.verify_hint':     'Enter your full name and the last 4 digits of WhatsApp (same as on your application). If you have your application number, you may use number + email or last 4 digits instead.',
      'sch.no':              'Full name',
