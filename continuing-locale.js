...
(function (root) {
  ...
  var DICT = {
    zh: {
      ...
      'lookup.name':      '姓名',
      'lookup.name_ph':   '与申请表一致的姓名',
      'lookup.secret':    '邮箱或 WhatsApp 后 4 位',
      'lookup.secret_ph': '提交申请时所留邮箱，或 WhatsApp 号码末 4 位数字',
      'lookup.btn':       '查询',
      'lookup.empty':     '请输入姓名和邮箱或 WhatsApp 后 4 位',
      'lookup.secret_invalid': '请填写完整邮箱，或 WhatsApp 后 4 位数字',
      'lookup.not_found': '未找到匹配记录，请核对姓名与邮箱或 WhatsApp 后 4 位是否一致。',
      'lookup.failed':    '查询失败，请稍后重试。',
      'lookup.year':      '申请年级',
      'lookup.class_lang':'班级语言',
      'lookup.app_no':    '申请编号',
      'lookup.admission': '录取状态',
      'lookup.submitted_at':'提交时间',
      'lookup.updated_at':'最近更新',
      'lookup.aid_intent':'资助意向',
      'lookup.return':    '返回填写新申请',
      'lookup.sch_title': '奖学金',
      'lookup.sch_apply': '申请情况',
      'lookup.sch_approval': '批复情况',
      'lookup.sch_none':  '尚未提交',
      'lookup.sch_pending_approval': '待批复',
      'lookup.sch_reviewing': '审核中',
      'lookup.sch_submitted_amt': '已申请 ${amount}',
      'lookup.sch_approved_amt': '批复 ${amount}',
      'lookup.sch_pill_submitted': '已提交',
      'lookup.sch_pill_approved': '已批复',
      'lookup.sch_not_admitted_hint': '录取通过后可申请奖学金',
      ...
      'app.open_title':   '申请通道已开放',
      'app.open_notice':  '尚未提交进深课程申请的同学请尽快填写。',
    },
    ...
    id: {
      ...
      'lookup.name':      'Nama lengkap',
      'lookup.name_ph':   'Sama dengan formulir pendaftaran',
      'lookup.secret':    'Email atau 4 digit terakhir WhatsApp',
      'lookup.secret_ph': 'Email saat mendaftar, atau 4 digit terakhir nomor WhatsApp',
      'lookup.btn':       'Cek',
      'lookup.empty':     'Masukkan nama dan email atau 4 digit terakhir WhatsApp',
      'lookup.secret_invalid': 'Masukkan email lengkap atau 4 digit terakhir WhatsApp',
      'lookup.not_found': 'Data tidak ditemukan. Periksa nama dan email atau 4 digit WhatsApp.',
      'lookup.failed':    'Gagal memuat, mohon coba lagi.',
      'lookup.year':      'Jenjang',
      'lookup.class_lang':'Bahasa kelas',
      'lookup.app_no':    'Nomor permohonan',
      'lookup.admission': 'Status penerimaan',
      ...
      'lookup.sch_title': 'Beasiswa',
      'lookup.sch_apply': 'Status permohonan',
      'lookup.sch_approval': 'Status persetujuan',
      'lookup.sch_none':  'Belum diajukan',
      'lookup.sch_pending_approval': 'Menunggu persetujuan',
      'lookup.sch_reviewing': 'Sedang ditinjau',
      'lookup.sch_submitted_amt': 'Diajukan ${amount}',
      'lookup.sch_approved_amt': 'Disetujui ${amount}',
      'lookup.sch_pill_submitted': 'Diajukan',
      'lookup.sch_pill_approved': 'Disetujui',
      'lookup.sch_not_admitted_hint': 'Beasiswa dapat diajukan setelah diterima',
      ...
      'app.open_title':   'Pendaftaran dibuka',
      'app.open_notice':  'Mohon segera isi formulir jika belum mendaftar.',
    },
    ...
    en: {
      ...
      'lookup.name_ph':   'Same as on your application form',
      'lookup.secret':    'Email or last 4 digits of WhatsApp',
      'lookup.secret_ph': 'Email on your application, or last 4 digits of WhatsApp',
      'lookup.btn':       'Look up',
      'lookup.empty':     'Please enter your name and email or WhatsApp last 4 digits',
      'lookup.secret_invalid': 'Enter a full email address or exactly 4 digits',
      'lookup.not_found': 'No matching record. Please check your name and email or WhatsApp last 4 digits.',
      'lookup.failed':    'Lookup failed, please try again.',
      'lookup.year':      'Year applying for',
      'lookup.class_lang':'Class language',
      'lookup.app_no':    'Application no.',
      'lookup.admission': 'Admission status',
      ...
      'lookup.sch_title': 'Scholarship',
      'lookup.sch_apply': 'Application',
      'lookup.sch_approval': 'Approval',
      'lookup.sch_none':  'Not submitted',
      'lookup.sch_pending_approval': 'Pending approval',
      'lookup.sch_reviewing': 'Under review',
      'lookup.sch_submitted_amt': 'Requested ${amount}',
      'lookup.sch_approved_amt': 'Approved ${amount}',
      'lookup.sch_pill_submitted': 'Submitted',
      'lookup.sch_pill_approved': 'Approved',
      'lookup.sch_not_admitted_hint': 'Scholarship opens after admission',
      ...
      'app.open_title':   'Applications are open',
      'app.open_notice':  'If you have not yet submitted your application, please do so soon.',
    },
  };
  ...
  var SCH_DICT = {
    zh: {
      ...
      'sch.no':              '姓名',
      'sch.no_ph':           '与申请表一致的姓名',
      'sch.secret':          '邮箱或 WhatsApp 后 4 位',
      'sch.secret_ph':       '申请时所留邮箱，或手机号/WhatsApp 末 4 位',
      'sch.verify_btn':      '验证身份',
      'sch.verifying':       '验证中…',
      ...
      'sch.deadline_date':   '2026年6月26日（周五）晚 10:00（印尼时间 WIB）',
      'sch.deadline_expired':'🚫 奖学金申请已截止',
      'sch.deadline_notice': '⏰ 请在 2026年6月26日（周五）晚 10:00（WIB）前提交奖学金申请。',
      'sch.deadline_d': '天', 'sch.deadline_h': '时', 'sch.deadline_m': '分', 'sch.deadline_s': '秒',
      'sch.open_title':  '奖学金申请通道已开放',
      'sch.open_notice': '已录取同学请尽快填写奖学金申请。',
    },
    id: {
      ...
      'sch.secret_ph':       'Email pendaftaran atau 4 digit terakhir nomor/WA',
      ...
      'sch.deadline_date':   'Jumat, 26 Juni 2026, pukul 22:00 WIB',
      'sch.deadline_expired':'🚫 Permohonan beasiswa telah ditutup',
      'sch.deadline_notice': '⏰ Ajukan beasiswa sebelum Jumat, 26 Juni 2026, pukul 22:00 WIB.',
      'sch.deadline_d': 'hari', 'sch.deadline_h': 'jam', 'sch.deadline_m': 'mnt', 'sch.deadline_s': 'dtk',
      'sch.open_title':  'Permohonan beasiswa dibuka',
      'sch.open_notice': 'Mahasiswa yang diterima mohon segera mengajukan beasiswa.',
    },
    en: {
      ...
      'sch.secret_ph':       'Application email or last 4 digits of phone/WA',
      ...
      'sch.deadline_date':   'Friday, June 26, 2026 at 10:00 PM (WIB)',
      'sch.deadline_expired':'🚫 Scholarship applications are now closed',
      'sch.deadline_notice': '⏰ Please submit your scholarship application by Friday, June 26, 2026, 10:00 PM (WIB).',
      'sch.deadline_d': 'days', 'sch.deadline_h': 'hrs', 'sch.deadline_m': 'min', 'sch.deadline_s': 'sec',
      'sch.open_title':  'Scholarship applications are open',
      'sch.open_notice': 'Admitted students, please submit your scholarship application soon.',
    },
  };
  ...
  root.CL = {
    ...
    /** 继续申请（报名表）暂不截止 */
    CONTINUING_APPLICATION_OPEN: true,
    /** @deprecated 仅用于继续申请页；奖学金请看 SCH_DEADLINE_ISO */
    CONTINUING_CHANNELS_OPEN: true,
    SCH_DEADLINE_ISO: '2026-06-26T22:00:00+07:00',
    isApplicationDeadlinePassed: function () {
      return !this.CONTINUING_APPLICATION_OPEN;
    },
    isScholarshipDeadlinePassed: function () {
      return new Date() > new Date(this.SCH_DEADLINE_ISO);
    },
    isValidContinuingSecret: function (sec) {
      sec = String(sec || '').trim();
      if (!sec) return false;
      if (/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(sec)) return true;
      return /^\d{4}$/.test(sec);
    },
  };
