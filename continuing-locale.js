...
(function (root) {
  ...
  var SCH_DICT = {
    zh: {
      ...
      'sch.amount_hint':     '参考费用：学费 $3,000 + 餐费 $1,200（$100×12）+ 宿舍 $1,200（$100×12）+ 注册费 $80，共 $5,480。请结合自身情况填写所需资助金额。',
      'sch.desc':            '家庭经济情况简述',
      'sch.desc_ph':         '请简要说明家庭经济状况、主要收入来源、是否有教会/机构支持等，500字以内。',
      'sch.commitment_h':    '承诺书',
      'sch.commitment_text': '本人承诺：以上所填信息真实准确；若获得奖助学金，将全力完成进深课程学业；如未能完成（除不可抗力外），愿意按学院规定处理。',
      'sch.commitment_check':'我已阅读并同意以上承诺书内容',
    ...
    id: {
      ...
      'sch.form_h':          'Formulir Permohonan Beasiswa',
      ...
      'sch.amount_hint':     'Referensi biaya: kuliah $3.000 + makan $1.200 ($100×12) + asrama $1.200 ($100×12) + pendaftaran $80 = total $5.480. Isi sesuai kebutuhan Anda.',
      ...
      'sch.commitment_text': 'Saya menyatakan bahwa informasi di atas benar dan akurat; jika menerima beasiswa, saya berkomitmen menyelesaikan program; jika tidak selesai (kecuali force majeure), saya bersedia mengikuti ketentuan institusi.',
      'sch.commitment_check':'Saya telah membaca dan menyetujui pernyataan di atas',
    ...
    en: {
      ...
      'sch.form_h':          'Scholarship Application Form',
      ...
      'sch.amount_hint':     'Reference costs: tuition $3,000 + meals $1,200 ($100×12) + dormitory $1,200 ($100×12) + registration $80 = $5,480 total. Enter the amount you need.',
      ...
      'sch.commitment_text': 'I certify that the information above is true and accurate; if I receive a scholarship I commit to completing the program; if I do not complete it (except for force majeure), I agree to follow the institution\'s regulations.',
      'sch.commitment_check':'I have read and agree to the commitment statement above',
